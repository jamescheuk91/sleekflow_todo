defmodule SleekFlowTodo.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind sleekflow_todo", "esbuild sleekflow_todo"],
      "assets.deploy": [
        "tailwind sleekflow_todo --minify",
        "esbuild sleekflow_todo --minify",
        "phx.digest"
      ]
    ]
  end
