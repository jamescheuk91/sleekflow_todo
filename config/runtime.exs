...
if config_env() == :prod do
  # Enable debug logging for DNSCluster
  config :logger, :console, level: :debug

  sentry_dsn = System.get_env("SENTRY_DSN") || raise "enviroment variable SENTRY_DSN is missing"
  ...
  projection_database_url =
    System.get_env("PROJECTION_DATABASE_URL") ||
      raise """
      environment variable PROJECTION_DATABASE_URL is missing.
      For example: ecto://USER:PASS@HOST/DATABASE
      """
  ...
  config :sleekflow_todo, SleekFlowTodo.ProjectionRepo,
    ...
    url: projection_database_url,
    pool_size: String.to_integer(System.get_env("POOL_SIZE") || "10"),
    socket_options: maybe_ipv6

  config :sleekflow_todo, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :sleekflow_todo, SleekFlowTodo.Mailer,
