...
config :sleekflow_todo,
  event_stores: [SleekFlowTodo.EventStore],
  ecto_repos: [SleekFlowTodo.ProjectionRepo],
...
config :sleekflow_todo, SleekFlowTodo.Mailer, adapter: Swoosh.Adapters.Local
